...
if __name__ == "__main__":
    ...
    # sol_pbs_stgcs = SP_STRRTStar(env, tmax=tf, vlimit=vlimit, safe_radius=robot_radius, starts=starts, goals=goals, t0s=T0s, seed=seed, timeout_secs=150, use_CSpace=True)
